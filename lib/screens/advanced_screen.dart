...
class AdcancedScreen extends StatefulWidget {
  @override
  _AdcancedScreenState createState() => _AdcancedScreenState();
}

class _AdcancedScreenState extends State<AdcancedScreen> {
  ...
  _getChannelInfo() async {
    ...
    _playListId = "PLW-zSkCnZ-gB0RgkvF0NaN-dreQS1DsxB";
